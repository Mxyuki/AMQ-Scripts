// ==UserScript==
// @name         AMQ Talking Waifu
// @namespace    https://github.com/Mxyuki/
// @version      0.1
// @description  Wtf i'm fucking weird doing that. Script of pure chaos totally useless
// @author       Mxyuki
...
let loadInterval = setInterval(() => {
    if (document.getElementById("loadingScreen").classList.contains("hidden")) {
        ...
        BossWindow.open();
        document.getElementById('BossWindowTest').style.backgroundImage="url(https://media.discordapp.net/attachments/553924474173653002/1013929086780977263/1.png)";
    }
}, 500);
...
let BossWindow;
let img = 1;
var friends = ["qwecocacola", "Karlos", "Maru_", "Symbios", "AnjuShiratori"];
...
function setup() {
        ...
        //gameChat.systemMessage("𝐋𝐢𝐥𝐢𝐭𝐡: " + "Hello this is a test");

        //1 document.getElementById('BossWindowTest').style.backgroundImage="url(https://media.discordapp.net/attachments/553924474173653002/1013929086780977263/1.png)";
        //2 document.getElementById('BossWindowTest').style.backgroundImage="url(https://media.discordapp.net/attachments/553924474173653002/1013929087116525618/2.png)";
        //3 document.getElementById('BossWindowTest').style.backgroundImage="url(https://media.discordapp.net/attachments/553924474173653002/1013929087494008862/3.png)";
        //4 document.getElementById('BossWindowTest').style.backgroundImage="url(https://media.discordapp.net/attachments/553924474173653002/1013929087854723142/4.png)";
        //5 document.getElementById('BossWindowTest').style.backgroundImage="url(https://media.discordapp.net/attachments/553924474173653002/1013929088324489256/5.png)";
        //6 document.getElementById('BossWindowTest').style.backgroundImage="url(https://media.discordapp.net/attachments/553924474173653002/1013929088718741634/6.png)";




//Let you know when someone from the list firends connect

let friendConnect = new Listener("friend state change", (friend) => {
	if (friend.online && friends.includes(friend.name)) {

            document.getElementById('BossWindowTest').style.backgroundImage="url(https://media.discordapp.net/attachments/553924474173653002/1013929086780977263/1.png)";

                  $("#BossTextH3").text("Oiii ! "+friend.name+" is online");

            document.getElementById("BossPanel1").style.backgroundColor = "rgba(0, 0, 0, .5)";

    let loadInterval = setInterval(() => {

            document.getElementById('BossWindowTest').style.backgroundImage="url(https://media.discordapp.net/attachments/553924474173653002/1013929087116525618/2.png)";

                  $("#BossTextH3").text("");

            document.getElementById("BossPanel1").style.backgroundColor = "rgba(0, 0, 0, 0)";
     }, 5000);
	}
});
...
let chatMessage = new Listener("chat message", (chat) => {

    document.getElementById('BossWindowTest').style.backgroundImage="url(https://media.discordapp.net/attachments/553924474173653002/1013929086780977263/1.png)";

                  $("#BossTextH3").text("Oiii ! "+chat.sender+" sent you a chat");
...
BossWindow.panels[0].panel.append(
    $(`<div id="BossPanel1"></div>`)
        .append(
            `<div id="BossText">
                    <H3 id="BossTextH3">Ceci est un texte long pur voir ce que ca donne quand le texte est long olala il est long ce texte dit donc</H3>
                </div>`
        )
    )
