...
function skinFiltering() {
    ...
    if (!locked) {
        ...
        if ((tier0 && tier1 && tier2 && tier3)) {
            $('.swAvatarTile.swMainContent.floatingContainer.clickAble.unlocked .swAvatarTileTypeContainer .swAvatarTileType.rightLeftTopBottom .swAvatarTileRarityColor.hide').closest('.hidden').removeClass('hidden');
